...
source/%.o: ../source/%.c
	...
	arm-linux-gnueabihf-gcc -I/usr/arm-linux-gnueabihf/include/xenomai/include -I/usr/arm-gcc/arm-linux-gnueabihf/include -I/usr/arm-linux-gnueabihf/include/ne10 -I/import/teaching/ECS732/arm-gcc/arm-linux-gnueabihf/include -I/import/teaching/ECS732/arm-gcc/arm-linux-gnueabihf/include/xenomai/include -O2 -g3 -Wall -c -fmessage-length=0 -Wpointer-arith -Wunused-result  -D_GNU_SOURCE -D_REENTRANT -D__XENO__ -std=gnu99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
